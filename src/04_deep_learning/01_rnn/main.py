...
class RNNPredictor(nn.Module):
    """Vanilla RNN-based sequence predictor for vessel trajectories.
...
if __name__ == "__main__":
    ...
    model = RNNPredictor(input_size=n_features, hidden_size=64, num_layers=2, output_size=1)
